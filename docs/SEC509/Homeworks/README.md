...
### [Lab 1: Threat Modeling](./Lab1/README.md)

- **Topic:** System analysis and threat identification.
- **Description:** Performed a comprehensive threat model for the _OrcunCorp Document Sharing Tool_ using the STRIDE methodology and Microsoft Threat Modeling Tool.

### [Lab 2: Cybersecurity Awareness](./Lab2/README.md)
